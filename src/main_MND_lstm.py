...
from Model_deForMND_lstm_att import *
from utils import *
import torch
...
features_path_train = '../features/timit_train_mfcc_lpcc_585.json' #all features with fixed size
targets_path_train = '../targets/timit_train_phonemes.txt' #all translations not padded

features_path_test = '../features/timit_test_mfcc_lpcc_585.json'
...
def train(model, asrdata):
    ...
    scheduler_1 = MultiStepLR(optimizer_1, milestones=[50, 80], gamma=0.1)
